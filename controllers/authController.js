...
exports.signup = async (req, res, next) => {
  try {
    ...
    if (error.code === 11000) error.message = "This email has been used for another account";
...
exports.protect = async (req, res, next) => {
  try {
    ...
    if (!verifiedUser) throw new AppError("The user belonging to this token no longer exist.", 401);
